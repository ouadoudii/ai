...
export default function App(){
  ...
  const content=activeTab==='type_analysis'
    ...
    : activeTab==='timeline'
      ...
      : <TodayHomeView moments={moments} checkIns={checkIns} onSelectMoment={setSelectedMomentDetail} onOpenAddModal={openCapture} onOpenCheckInModal={(phase)=>beginCheckIn('today_phase_card',phase)} onOpenSnack={()=>openFoodCapture('snack')} onNavigateToCoach={()=>{}} onNavigateToTypeAnalysis={()=>setActiveTab('type_analysis')} onNavigateToTimeline={()=>setActiveTab('timeline')} onSaveCheckIn={handleSaveCheckIn}/>;
