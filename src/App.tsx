...
export default function App(){
  ...
  const localizedMoments=React.useMemo(()=>moments.map(moment=>localizeCheckInMoment(moment,language)),[moments,language]);
