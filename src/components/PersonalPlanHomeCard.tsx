...
export const PersonalPlanHomeCard:React.FC<Props>=({onStart})=>{
  ...
  const copy=language==='de'
    ?{eyebrow:'Dein persönlicher Start',why:'Warum das zu dir passt',next:'Dein nächster Schritt',cta:'Check-in starten'}
    :language==='fr'
      ?{eyebrow:'Ton départ personnalisé',why:'Pourquoi cela te correspond',next:'Ta prochaine étape',cta:'Commencer le check-in'}
      :language==='ar'
        ?{eyebrow:'بدايتك الشخصية',why:'لماذا يناسبك هذا',next:'خطوتك التالية',cta:'ابدأ التسجيل'}
        :{eyebrow:'Your personal start',why:'Why this fits you',next:'Your next step',cta:'Start check-in'};
