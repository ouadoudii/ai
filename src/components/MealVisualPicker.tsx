...
const breakfastOptions: MealOption[] = [
  ...
  },
  {
    ...
    label: 'Leicht',
    imageUrl: 'https://images.unsplash.com/photo-1505252585461-04db1eb84625?w=600&auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    alt: 'Leerer Platz mit Getränk als Symbol für kein Frühstück',
  },
];
...
const mainMealOptions: MealOption[] = [
  ...
  },
  {
    ...
    alt: 'Tellergericht mit Protein, Gemüse und Beilage',
  },
  {
  ...
  },
  {
    ...
    label: 'Snack & Süßes',
    imageUrl: 'https://images.unsplash.com/photo-1486427944299-d1955d23e34d?w=600&auto=format&fit=crop&q=80',
