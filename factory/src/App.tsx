      ...
      try {
        const response = await fetch('/api/status', {
          ...
          body: JSON.stringify({
            ...
            productionSha: job.productionSha,
          }),
        });
    ...
    <main className="shell">
      ...
      {auth === 'locked' && (
        <form className="card" onSubmit={login}>
          ...
          <p className="hint">Der persönliche Zugang wird als sicherer HttpOnly-Session-Cookie gespeichert. Danach gibst du nur noch Geschäftsideen ein.</p>
          <button disabled={busy || accessKey.length < 1} type="submit">Factory öffnen</button>
